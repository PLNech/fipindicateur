...
// Conditional sections (epochs, ciel, economie, gout) return null when their
// data is absent, and the rundown simply skips them.
const SECTIONS = [grille, zapping, epochs, ciel, economie, gout, palmares, fin];
